    ...
    (
      ...
      >
        ...
        <div style={{ position: "relative", display: "flex", flexDirection: "column", gap: 18 }}>
          <span style={{ fontSize: 24, color: "#e3c04a", background: "rgba(201,162,39,0.15)", border: "1px solid rgba(201,162,39,0.35)", borderRadius: 999, padding: "6px 18px", alignSelf: "flex-start" }}>
            {a.tag}
          </span>
          <div style={{ fontSize: 58, fontWeight: 700, color: "#ffffff", lineHeight: 1.12, letterSpacing: "-1px" }}>
            {a.title}
          </div>
        </div>
        ...
        <div style={{ position: "relative", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <span style={{ fontSize: 26, color: "#cdd9e1" }}>{fmtDate(a.date, locale)}</span>
          <span style={{ fontSize: 24, color: "#8aa0b0" }}>Read on seajobs.pro</span>
        </div>
