...
export const FAQ_APPLY: FaqItem[] = [
  ...
  },
  {
    ...
    a: {
      en: "Your full CV — contacts, documents and visas, certificates, sea service and your cover letter — is formatted and sent to the crewing agency. If the company has an account on SeaJobs.pro it also lands in their dashboard; if the vacancy came with a crewing e-mail, it goes straight to that address. Either way the application appears in your own list, where you follow its status. The same window also offers a second route: instead of sending through the portal you can open the letter in your own mail app — already addressed, with the subject written and a link to your CV. It arrives as a personal letter from you and the agency replies straight to your inbox.",
      ru: "Ваше полное CV — контакты, документы и визы, сертификаты, морской стаж и сопроводительное письмо — оформляется и отправляется в крюинговое агентство. Если у компании есть аккаунт на SeaJobs.pro, отклик попадает в её кабинет; если у вакансии указан крюинговый email — уходит прямо на этот адрес. В любом случае отклик появляется в вашем списке, где видно его статус. В том же окне есть и второй путь: вместо отправки через портал можно открыть письмо в своей почтовой программе — адрес и тема уже подставлены, а вместо вложения идёт ссылка на ваше CV. Письмо приходит как личное от вас, и агентство отвечает прямо вам на почту.",
      ua: "Ваше повне CV — контакти, документи та візи, сертифікати, морський стаж і супровідний лист — оформлюється й надсилається до крюїнгового агентства. Якщо в компанії є акаунт на SeaJobs.pro, відгук потрапляє в її кабінет; якщо у вакансії вказано крюїнговий email — іде прямо на цю адресу. У будь-якому разі відгук з'являється у вашому списку, де видно його статус. У тому ж вікні є й другий шлях: замість надсилання через портал можна відкрити лист у власній поштовій програмі — адреса й тема вже підставлені, а замість вкладення йде посилання на ваше CV. Лист приходить як особистий від вас, і агентство відповідає прямо вам на пошту.",
      pl: "Twoje pełne CV — kontakty, dokumenty i wizy, certyfikaty, staż morski i list motywacyjny — zostaje sformatowane i wysłane do agencji crewingowej. Jeśli firma ma konto na SeaJobs.pro, aplikacja trafia do jej panelu; jeśli przy ofercie podano e-mail crewingu — idzie prosto na ten adres. Tak czy inaczej aplikacja pojawia się na Twojej liście, gdzie widzisz jej status. W tym samym oknie jest też druga droga: zamiast wysyłki przez portal możesz otworzyć list we własnym programie pocztowym — adres i temat są już wpisane, a zamiast załącznika idzie link do Twojego CV. List przychodzi jako osobisty od Ciebie, a agencja odpowiada wprost na Twoją skrzynkę.",
      ro: "CV-ul tău complet — contacte, documente și vize, certificate, stagiu pe mare și scrisoarea de intenție — este formatat și trimis agenției de crewing. Dacă firma are cont pe SeaJobs.pro, aplicarea ajunge și în panoul ei; dacă anunțul are un e-mail de crewing, ajunge direct la acea adresă. Oricum, aplicarea apare în lista ta, unde îi urmărești statusul. În aceeași fereastră există și a doua cale: în loc să trimiți prin portal, poți deschide scrisoarea în propriul program de e-mail — adresa și subiectul sunt deja completate, iar în locul atașamentului merge un link către CV-ul tău. Ajunge ca o scrisoare personală de la tine, iar agenția răspunde direct pe e-mailul tău.",
    },
  },
  {
    q: {
