...
export const T: Record<Lang, Record<string, string>> = {
  ua: {
    ...
    stat_jobs: "Відкритих вакансій",
    stat_companies: "Крюїнгових компаній",
    stat_seafarers: "Зареєстрованих моряків",
  },
  pl: {
    nav_jobs: "Oferty",
    nav_forum: "Forum",
    ...
    stat_jobs: "Otwartych ofert",
    stat_companies: "Firm crewingowych",
    stat_seafarers: "Zarejestrowanych marynarzy",
  },
  ru: {
    nav_jobs: "Вакансии",
    nav_forum: "Форум",
    ...
    stat_jobs: "Открытых вакансий",
    stat_companies: "Крюинговых компаний",
    stat_seafarers: "Зарегистрированных моряков",
  },
  en: {
    nav_jobs: "Vacancies",
    nav_forum: "Forum",
    ...
    stat_jobs: "Open vacancies",
    stat_companies: "Crewing companies",
    stat_seafarers: "Registered seafarers",
  },
};
